                ...
                <div className="nav-left" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="nav-hover-trigger">
                        <div className="logo-work-container">
                            ...
                            <span className="logo-work-text">студия</span>
                        </div>
                            ...
                            <div className="nav-popout-inner">
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="/assets/photos/class1.jpeg" loading="eager" alt="Занятие по хип-хопу" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-maroon">хип-хоп</span>
                                        <h4 className="nav-work-title">баттлы каждую пятницу</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="/assets/photos/ballet1.jpeg" loading="eager" alt="Балетный класс" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">балет</span>
                                        <h4 className="nav-work-title">балет для взрослых</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__img-wrap">
                                        <img src="/assets/photos/side_hiphop.jpeg" loading="eager" alt="Выступление на сцене" className="nav-work-item__img" />
                                    </div>
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-pink">сцена</span>
                                        <h4 className="nav-work-title">отчётный концерт</h4>
                                    </div>
                                </div>
                                <a href="#" className="nav-work-btn"><span className="nav-work-btn__text">Все направления</span></a>
                            </div>
                        </div>
                    </div>
                </div>
