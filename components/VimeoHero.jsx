            ...
            >
                ...
                <div className="home-header__title">
                    <h1 className="vimeo-hero__title" ref={titleRef} onClick={(e) => e.stopPropagation()}>
                        ...
                        {/* "we" */}
                        <span className="vimeo-hero__word is--relative" style={{ marginLeft: "1.15em" }}>
                            <span>мы </span>
                            <div className="home-header__smiley" style={{ left: "-1.05em", top: "-0.3em" }}>
                                <img
                        ...
                        {/* "advertising" italic */}
                        <span className="vimeo-hero__word"><em>танцевать </em></span>

                        {/* "for" */}
                        <span className="vimeo-hero__word">тех </span>

                        <div style={{ flexBasis: '100%', height: 0 }} />

                        <span className="vimeo-hero__word">кто </span>
                        <span className="vimeo-hero__word">реально </span>
