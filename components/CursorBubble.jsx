...
export default function CursorBubble() {
    useEffect(() => {
        ...
        const onMouseOver = (e) => {
            ...
            if (found && !isHoveringClickable) {
                ...
                if (found.matches('.logo-truus')) cursorBubble.textContent = 'наверх';
                else if (found.matches('.nav-work-btn')) cursorBubble.textContent = 'смотреть';
                else cursorBubble.textContent = 'смотреть';
    ...
    return <div className="cursor-bubble">жми</div>;
}
